...
// Returns the private 'App\Repository\AccordRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AccordRepository.php';

return $this->privates['App\Repository\AccordRepository'] = new \App\Repository\AccordRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
