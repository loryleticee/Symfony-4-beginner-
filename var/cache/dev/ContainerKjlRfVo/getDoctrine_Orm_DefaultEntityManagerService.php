...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AccordRepository' => function () {
    return ($this->privates['App\Repository\AccordRepository'] ?? $this->load('getAccordRepositoryService.php'));
